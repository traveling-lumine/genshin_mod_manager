// Copyright 2020, the Dart project (filepicker_windows from win32.pub) authors.
// All rights reserved.
...
class OpenNoDereferenceFilePicker extends FileDialog {
  ...
  OpenNoDereferenceFilePicker() : super() {
    fileMustExist = true;
  }
